...
#
airflow connections add aws_credentials --conn-uri 'aws://AKIAS3A25IYKEMTEXFOG:WgSXcGajfW%2FpzXB8VEAIWL3KLCGH5%2BE%2FQka1rN4M@'
#
#
# TO-DO: run the follwing command and observe the JSON output: 
...
# TO-DO: Update the following command with the URI and un-comment it:
#
airflow connections add redshift --conn-uri 'redshift://awsuser:2001stKh@default.195477456404.us-east-1.redshift-serverless.amazonaws.com:5439/dev'
#
# TO-DO: update the following bucket name to match the name of your S3 bucket and un-comment it:
#
airflow variables set s3_bucket udacity-anhtu12st1
#
